...
export const en = {
  ...
  tileTextColor: "Text Color",
  tileTextColorDefault: "Use default text color",
  tileVisibility: "Show on tile",
  tileVisibilityHint: "Hide the label or icon for image-only tiles. Spoken text is unaffected.",
  tileHideLabel: "Hide label",
  tileHideIcon: "Hide icon",
